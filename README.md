...
- Le prompt a été amélioré pour afficher le statut de la dernière commande, par exemple `[exit:0]` ou `[sign:9]`. 
...
- Le temps est affiché en millisecondes dans le prompt, par exemple `[exit:0|10ms]`. 
